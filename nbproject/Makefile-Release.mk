...
${OBJECTDIR}/ANB.o: ANB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ANB.o ANB.cpp
...
${OBJECTDIR}/HAStorageManager.o: HAStorageManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HAStorageManager.o HAStorageManager.cpp

${OBJECTDIR}/Jzon.o: Jzon.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Jzon.o Jzon.cpp

${OBJECTDIR}/Markup.o: Markup.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Markup.o Markup.cpp
...
${OBJECTDIR}/ANB_nomain.o: ${OBJECTDIR}/ANB.o ANB.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ANB_nomain.o ANB.cpp;\
	else  \
...
${OBJECTDIR}/Disk_File_nomain.o: ${OBJECTDIR}/Disk_File.o Disk_File.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Disk_File_nomain.o Disk_File.cpp;\
	else  \
...
${OBJECTDIR}/HAStorageManager_nomain.o: ${OBJECTDIR}/HAStorageManager.o HAStorageManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HAStorageManager_nomain.o HAStorageManager.cpp;\
	else  \
...
${OBJECTDIR}/Jzon_nomain.o: ${OBJECTDIR}/Jzon.o Jzon.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Jzon_nomain.o Jzon.cpp;\
	else  \
...
${OBJECTDIR}/Markup_nomain.o: ${OBJECTDIR}/Markup.o Markup.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Markup_nomain.o Markup.cpp;\
	else  \
...
${OBJECTDIR}/RegisterPointer_nomain.o: ${OBJECTDIR}/RegisterPointer.o RegisterPointer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegisterPointer_nomain.o RegisterPointer.cpp;\
	else  \
...
${OBJECTDIR}/RegisterPointerNode_nomain.o: ${OBJECTDIR}/RegisterPointerNode.o RegisterPointerNode.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RegisterPointerNode_nomain.o RegisterPointerNode.cpp;\
	else  \
...
${OBJECTDIR}/SLL_nomain.o: ${OBJECTDIR}/SLL.o SLL.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SLL_nomain.o SLL.cpp;\
	else  \
...
${OBJECTDIR}/SLLNode_nomain.o: ${OBJECTDIR}/SLLNode.o SLLNode.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SLLNode_nomain.o SLLNode.cpp;\
	else  \
...
${OBJECTDIR}/header_nomain.o: ${OBJECTDIR}/header.o header.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/header_nomain.o header.cpp;\
	else  \
...
${OBJECTDIR}/schema_nomain.o: ${OBJECTDIR}/schema.o schema.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/schema_nomain.o schema.cpp;\
	else  \
